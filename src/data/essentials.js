    ...
    //Data for different tracks are all Objects
{
    ...
    softwareNames: ['Software 1','Software 2','Software 3','Software 4','Software 5','Software 6','Software 7','Software 8']
},
{
    title: 'Back-End',
    path: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Circle_-_black_simple.svg/1024px-Circle_-_black_simple.svg.png',
...
export const essentialItems = ['Essential Item here','Essential Item here','Essential Item here','Essential Item here','Essential Item here','Essential Item here','Essential Item here','Essential Item here']

export const optionalItems = ['Optional Item here','Optional Item here','Optional Item here','Optional Item here','Optional Item here','Optional Item here','Optional Item here','Optional Item here']