...
const Application = ({ history, userData, refresh }) => {
  ...
  const handleSubmit = values => {
    setLoading(true);
    const apply = async () =>
      await services.apply(values, history, refresh, faillure);
    apply();
  };
  ...
  let formValues =
    applicationStatus !== "not applied" ? userData : ApplicationInitialValues;
              ...
              <div className="agreement">
                ...
                <InlineError
                  shouldShow={
                    ...
                    (errors.mlhAffiliation && touched.mlhAffiliation) ||
                    (errors.sponsorPromo && touched.sponsorPromo)
                  }
                  error={
                    errors.mlh || errors.sponsorPromo || errors.mlhAffiliation
                  }
                />
              </div>
